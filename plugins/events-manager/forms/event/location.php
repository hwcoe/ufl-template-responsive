...
<div id="em-location-data" class="em-location-data">
	...
	<div class="em-location-fields">
		<?php esc_html_e('Location:','events-manager') ?>
	...
	<?php else : ?>
		<div class="em-location-fields">
			...
			?>
			<label><?php _e ( 'Location Name:', 'events-manager')?><?php echo $required; ?></label>
