...
<form enctype='multipart/form-data' id="event-form" method="post" action="<?php echo esc_url(add_query_arg(array('success'=>null))); ?>">
	<div class="wrap">
		...
		<div class="inside event-form-name">					
			...
			<p><em><?php esc_html_e('Example: Information Session', 'events-manager'); ?></em></p>
		...
		<div class="inside event-form-details">
			<div class="event-editor">
				...
				<?php else: ?>
					...
					<p><em><?php esc_html_e( 'Details about the event.', 'events-manager')?> <?php esc_html_e( 'HTML allowed.', 'events-manager')?></em></p>
				<?php endif; ?>
			</div>
